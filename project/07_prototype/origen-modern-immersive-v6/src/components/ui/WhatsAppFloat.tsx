export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="hidden md:flex fixed bottom-8 right-8 z-50 w-14 h-14 items-center justify-center bg-[#25D366] text-white rounded-full shadow-lg shadow-black/20 hover:scale-110 hover:shadow-xl transition-all duration-300"
    >
