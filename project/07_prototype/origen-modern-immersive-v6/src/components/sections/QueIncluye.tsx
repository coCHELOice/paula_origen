...
const itemImages = [
  '/media/house/dormitorio-doble.avif',
  '/media/house/desayuno.avif',
  ...
  return (
    <Section id="experiencia" className="bg-brand-bgAlt/50">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Items grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-12 sm:gap-y-16 md:gap-y-20 gap-x-8 md:gap-x-12 lg:gap-x-16">
          {queIncluye.includes.map((item, idx) => (
            <div key={idx} className="flex flex-col group">
              {/* Image */}
              <div className="aspect-[16/10] overflow-hidden mb-6 md:mb-8">
                <img
                  src={itemImages[idx]}
                  alt={item.t}
              ...
              <span className="font-sans text-[10px] sm:text-xs tracking-[0.25em] uppercase text-brand-accent mb-3 sm:mb-5">
                {item.t}
              </span>
