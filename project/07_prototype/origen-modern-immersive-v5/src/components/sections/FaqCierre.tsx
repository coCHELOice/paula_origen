  ...
  return (
    <Section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <img
          src="/media/selected_images/livin-centro-chimenea.avif"
          alt=""
      ...
      {/* FAQ */}
      <div className="relative max-w-2xl mx-auto mb-16 md:mb-24 lg:mb-28">
      ...
      {/* Cierre */}
      <div className="relative max-w-3xl mx-auto text-center px-2 sm:px-4 pb-12 md:pb-20 lg:pb-24">
